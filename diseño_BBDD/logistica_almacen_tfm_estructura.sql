...
CREATE TABLE `pedidos` (
  ...
  `estado` int NOT NULL,
  `detalle_pedido` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `id_transporte` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
